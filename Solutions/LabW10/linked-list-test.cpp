...
TEST(deleteNode, 3){
  LinkedList<int> a;
  ASSERT_ANY_THROW(a.deleteNode(1));
}

TEST(deleteNode, 4){
  LinkedList<int> a;
  ASSERT_ANY_THROW(a.deleteNode(0));
}
...
TEST(appendNode, double1){
  LinkedList<double> a;
  a.appendNode(1.2);
  EXPECT_EQ(a.getListAsString(), "1.2");
}

TEST(deleteNode, double1){
  LinkedList<double> a;
  a.appendNode(1.2);
  a.appendNode(2.3);
  a.appendNode(3.4);
  a.deleteNode(2.3);
  EXPECT_EQ(a.getListAsString(), "1.2 3.4");
}

TEST(deleteNode, double2){
  LinkedList<double> a;
  ASSERT_ANY_THROW(a.deleteNode(1.0));
}

TEST(deleteNode, double3){
  LinkedList<double> a;
  a.appendNode(1.2);
  a.appendNode(2.3);
  ASSERT_ANY_THROW(a.deleteNode(3.4));
}

TEST(countNode, double1){
  LinkedList<double> a;
  a.appendNode(1.2);
  a.appendNode(3.3);
  EXPECT_EQ(a.countNode(), 2);
...
TEST(countainNode, double1){
  LinkedList<double> a;
  a.appendNode(1.2);
  a.appendNode(2.3);
  a.deleteNode(1.2);
  a.appendNode(3.4);
  EXPECT_EQ(a.containNode(3.4), true);
}
