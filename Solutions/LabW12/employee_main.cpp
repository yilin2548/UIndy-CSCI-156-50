...
int getChoice(){
    ...
    cout << "4: Print Specific Employee" << endl;
    cout << "5: Print Specific Employee Compensation" << endl;
    cout << "6: Print Total Compensation" << endl;
    cout << "7: Exit" << endl;
    cin >> input;
...
Employee* getManager(vector<Employee*> employees){
    ...
    //cout << m->toString() << endl; //debug line
    return m;
} 

void printAllEmployees(vector<Employee*> employees){
    for (unsigned int i = 0; i < employees.size(); i++){
        cout << i << ": " << employees[i]->toString() << endl;
    }
}
...
void printCompensationForName(vector<Employee*> employees){
    ...
    cout << "Enter the name that you want to print info for:" << endl;
    cin >> name;
    cout << findEmployeeByName(name, employees)->getTotalCompensation() << endl;
}
